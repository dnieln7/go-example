...
SELECT id, name, created_at, updated_at, api_key FROM tb_users WHERE api_key = $1
`

func (q *Queries) GetUserByAPIKey(ctx context.Context, apiKey string) (TbUser, error) {
